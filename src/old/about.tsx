...
export const AboutUs: React.FC = () => {
  ...
  return (
    <div className="relative isolate bg-white px-6 py-12 sm:py-16 lg:px-8 dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-base font-semibold text-blue-600 dark:text-blue-400">About Us</h2>
      ...
      <div className="mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-8 md:grid-cols-2">
        ...
        >
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100">Who We Are</h2>
        ...
        >
          <h2 className="text-3xl font-bold mb-6 text-blue-600 dark:text-blue-400">Why Choose Us?</h2>
      ...
      >
        ...
        >
          <Link
            to="/"
            className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-all"
          >
            ⬅ Back to Home
          </Link>
        </motion.div>
