...
export const ThirdDashBoard: React.FC<DashboardProps> = ({ data }) => {
  ...
  // Format total revenue as currency (if needed)
  ...
  // Load and filter data for ThirdDashBoard criteria.
  useEffect(() => {
  ...
  // Helper function to normalize prescriber names.
  ...
  // Update filteredData whenever any filter or sorting changes.
  useEffect(() => {
    ...
    <motion.div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8">
        <h1 className="text-4xl font-bold text-blue-700 mb-6 text-center">
          MisMatching Prescriptions
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
  {/* Card 1: Total MisMatching Prescriptions */}
  <motion.div
    whileHover={{ scale: 1.02 }}
    className="bg-white dark:bg-gray-800 border-l-4 border-blue-500 dark:border-blue-400 rounded-lg shadow p-6 transition-transform duration-200"
  >
    <div className="flex flex-col sm:flex-row sm:items-center justify-between">
      <div>
        <p className="text-sm font-medium text-blue-500 dark:text-blue-400">
          Total MisMatching Prescriptions
        </p>
  ...
  {/* Card 2: Best Total Estimated Revenue */}
  <motion.div
    whileHover={{ scale: 1.02 }}
    className="bg-white dark:bg-gray-800 border-l-4 border-green-500 dark:border-green-400 rounded-lg shadow p-6 transition-transform duration-200"
  >
    <div className="flex flex-col sm:flex-row sm:items-center justify-between">
      <div>
  ...
  {/* Card 3: Current Total Revenue */}
  <motion.div
    whileHover={{ scale: 1.02 }}
    className="bg-white dark:bg-gray-800 border-l-4 border-purple-500 dark:border-purple-400 rounded-lg shadow p-6 transition-transform duration-200"
  >
    <div className="flex flex-col sm:flex-row sm:items-center justify-between">
      <div>
...
<div className="overflow-x-auto">
  <table className="table-auto min-w-full border-collapse">
    <thead className="bg-gray-100 dark:bg-gray-700 border-b dark:border-gray-600 sticky top-0 z-10">
      <tr>
        {[
          "Date",
          "Script Code",
