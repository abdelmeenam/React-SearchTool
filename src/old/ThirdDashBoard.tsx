      ...
      <div className=" px-4 sm:px-6 lg:px-10 py-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 border-l-4 border-blue-600 dark:border-blue-500 rounded-lg shadow p-6 transition-transform duration-200"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="bg-white dark:bg-gray-800 border-l-4 border-green-600 dark:border-green-500 rounded-lg shadow p-6 transition-transform duration-200"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
              <div className="min-w-0">
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="bg-white dark:bg-gray-800 border-l-4 border-purple-600 dark:border-purple-500 rounded-lg shadow p-6 transition-transform duration-200"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
              <div className="min-w-0">
