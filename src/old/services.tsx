  ...
  return (
    <>
      ...
      >
        ...
        {/* Disclaimer Section */}
        <section
          className="mt-12 mx-auto max-w-5xl bg-yellow-50 dark:bg-yellow-900 border-l-4 border-yellow-500 dark:border-yellow-400 p-6 rounded-xl"
          aria-label="Disclaimer"
        >
          <h2 className="text-lg font-semibold text-yellow-800 dark:text-yellow-200 mb-2">
            Disclaimer
          </h2>
          <p className="text-sm text-yellow-700 dark:text-yellow-100 leading-relaxed">
            This tool is intended solely to assist users in reviewing historical
            data and suggesting drug alternatives. It does not determine or
            confirm the final medication to be dispensed to the patient.
            Clinical decisions must always be made by qualified healthcare
            professionals. Additionally, reimbursement values and acquisition
            costs presented are based on the most recent historical data and do
            not reflect live or current market prices. Insurance coverage
            indications are also drawn from historical dispensing records and
            should be independently verified with each insurance provider at the
            time of prescribing or dispensing.
          </p>
        </section>
      </main>
    </>
