...
export const Cart: React.FC<CartProps> = ({
  ...
  return (
    <div className="relative bg-white dark:bg-gray-900">
      <section
        ref={cartRef}
        className={`fixed top-[64px] right-0 w-105 max-w-full h-[calc(100vh-64px)] p-6 shadow-2xl bg-white dark:bg-gray-900 z-50
      ...
      >
        {/* Rest of your cart content remains exactly the same */}
