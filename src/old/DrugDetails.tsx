        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {pageItems.map((rec, idx) => {
              ...
              if (rec.score >= 80)
                scoringClass =
                  "text-green-800 dark:text-green-100 dark:bg-green-800 px-2 py-1 rounded";
              else if (rec.score >= 60)
                scoringClass =
                  "text-yellow-800 dark:text-yellow-100 dark:bg-yellow-800 px-2 py-1 rounded";
              else if (rec.score >= 40)
                scoringClass =
                  "text-orange-800 dark:text-orange-100 dark:bg-orange-800 px-2 py-1 rounded";
              else
                scoringClass =
                  "text-red-800 dark:text-red-100 dark:bg-red-800 px-2 py-1 rounded";
