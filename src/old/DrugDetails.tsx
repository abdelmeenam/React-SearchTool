...
<div className="bg-blue-50 border-l-4 border-blue-600 shadow-lg rounded-lg p-6 mb-6">
  ...
  <div>
    ...
    <div className="relative mt-1">
      <input
        ...
        onChange={handleInsuranceFilterChange}
        placeholder="All"
        className="block w-full rounded-md border border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
      />
...
{/* 
  ...
  */}
  <div
    className="mt-4 flex items-center text-sm text-blue-700 cursor-pointer hover:text-blue-800 transition-colors"
    onClick={handleSort}
  >
    <ArrowUpDown className="h-4 w-4 mr-1" />
