...
/>
            ...
            <Route path="/drug-insurance-form" element={<DrugInsuranceForm />} />
            ...
            <Route path="/class-insurance-table" element={<ClassInsuranceTable />} />
            ...
            <Route path="/drug-insurance-table" element={<DrugInsuranceTable />} />
